...
create policy "Authenticated users can manage customer history"
  on public.customer_history for all to authenticated using (true) with check (true);

create policy "Authenticated users can manage customer notes"
  on public.customer_notes for all to authenticated using (true) with check (true);

create policy "Authenticated users can manage customer preferences"
  on public.customer_preferences for all to authenticated using (true) with check (true);

create policy "Authenticated users can manage customer loyalty"
  on public.customer_loyalty for all to authenticated using (true) with check (true);
