    ...
    <div className="flex min-h-screen items-center justify-center luxury-bg px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          This chair is empty. Let's get you back.
        </p>
        <div className="mt-6">
          <Link
            to="/"
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "King's Barber - Premium Barber Management" },
      { name: "description", content: "A luxurious management suite for King's Barber." },
